...
@NoArgsConstructor
@Document
public class BreadthFirstSearchEntity extends FirstSearchEntity {
    @Id
    private String id;

    public BreadthFirstSearchEntity(int hash, FirstSearchInput input, FirstSearchOutput output) {
