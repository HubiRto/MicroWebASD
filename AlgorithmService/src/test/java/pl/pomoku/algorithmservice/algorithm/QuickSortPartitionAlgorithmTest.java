...
public class QuickSortPartitionAlgorithmTest {
    ...
    public void quickSortPartitionResult1() {
        Integer[] arr = {18, 16, 10, 13, 15, 12, 9, 6, 19, 4, 7};
        ...
        Assertions.assertNotEquals(
                ...
                calculate(new Integer[]{16, 12, 15, 10, 18, 9, 19, 4, 7, 13, 6}).getPartitionCount()
        );
    }

    @Test
    public void quickSortPartitionResult2() {
        Integer[] arr = {11, 17, 9, 4, 12, 1, 7, 18, 0, 14, 2};
        QuickSortPartitionOutput output = calculate(arr);

        Assertions.assertEquals(output.getPartitionCount(), 8);
        Assertions.assertEquals(
                output.getQuickSortPartitionCount(),
                calculate(new Integer[]{18, 12, 14, 0, 9, 11, 7, 1, 17, 2, 4}).getQuickSortPartitionCount()
        );
        Assertions.assertNotEquals(
                output.getQuickSortPartitionCount(),
                calculate(new Integer[]{2, 11, 7, 17, 18, 9, 14, 12, 4, 0, 1}).getQuickSortPartitionCount()
        );
    }

    @Test
    public void quickSortPartitionResult3() {
        Integer[] arr = {12, 3, 16, 11, 15, 1, 18, 17, 9, 6, 2};
        QuickSortPartitionOutput output = calculate(arr);

        Assertions.assertEquals(output.getDepth(), 5);
        Assertions.assertNotEquals(
                output.getPartitionCount(),
                calculate(new Integer[]{15, 6, 12, 1, 17, 3, 9, 18, 2, 11, 16}).getPartitionCount()
        );
    ...
    public void quickSortPartitionResult4() {
        Integer[] arr = {11, 19, 4, 7, 18, 9, 0, 17, 15, 3, 13};
        QuickSortPartitionOutput output = calculate(arr);

        Assertions.assertEquals(output.getDepth(), 4);
        Assertions.assertEquals(
                output.getPartitionCount(),
                calculate(new Integer[]{4, 9, 18, 0, 15, 7, 13, 17, 11, 3, 19}).getPartitionCount()
        );
    ...
    public void quickSortPartitionResult5() {
        Integer[] arr = {13, 10, 18, 8, 9, 17, 4, 12, 3, 16, 19};
        QuickSortPartitionOutput output = calculate(arr);
        Assertions.assertEquals(
                output.getQuickSortPartitionCount(),
                calculate(new Integer[]{19, 18, 4, 13, 10, 8, 9, 16, 17, 3, 12}).getQuickSortPartitionCount()
        );
        Assertions.assertEquals(output.getPartitionCount(), 9);
        Assertions.assertArrayEquals(
                output.getSteps().get(0),
                new Integer[]{13, 10, 18, 8, 9, 17, 4, 12, 3, 16, 19}
        );
    }
}
