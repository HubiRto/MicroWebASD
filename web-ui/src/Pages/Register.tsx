                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="email" className="block text-sm font-medium text-gray-400">
                                Adres Email
                                <FontAwesomeIcon icon={validEmail ? faCheck : faXmark} className={`ml-2 ${validEmail ? "text-green-500" : "text-red-500"} ${!emailFocus ? "hidden" : ""}`} />
                            </label>
                            <input
                                type="email"
                                id="email"
                        ...
                        <p className={`bg-rose-400 rounded-lg border-2 border-rose-600 text-white mb-2 p-2 ${emailFocus && !validEmail ? '' : 'hidden'}`}>
                            Niepoprawny email
                        </p>
                        ...
                        <p className={`bg-red-400 rounded border-rose-500 text-white p-2 ${passwordFocus && !validPassword ? '' : 'hidden'}`}>
                            Nieprawidlowe haslo
                        </p>

                        <p className={`bg-red-400 rounded border-rose-500 text-white p-2 ${repeatPasswordFocus && !validRepeatPassword ? '' : 'hidden'}`}>
